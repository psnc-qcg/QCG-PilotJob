...
from qcg.pilotjob.common.allocation import CRAllocation, CRBindAllocation, NodeAllocation
from qcg.pilotjob.common.errors import InternalError, NotSufficientResources
...
class Node:
    ...
    def to_dict(self, **kwargs):
        ...
        if not kwargs.get('nodetails', False):
            result['core_ids'] = list(self._core_ids)
            result['free_cores'] = list(self._free_cores)
...
class Resources:
    ...
    def to_dict(self, **kwargs):
        ...
        """
        return {'type': self._type.name, 'nodes': [node.to_dict(**kwargs) for node in self._nodes],
