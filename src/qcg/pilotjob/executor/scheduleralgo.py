...
from qcg.pilotjob.common.allocation import Allocation
from qcg.pilotjob.common.errors import InternalError, InvalidResourceSpec, NotSufficientResources
from qcg.pilotjob.inputqueue.jobdesc import JobResources
...
class SchedulerAlgorithm:
    ...
    def allocate_cores(self, min_cores, max_cores=None):
        ...
        allocation = Allocation(self.resources.binding)
        allocated_cores = 0
